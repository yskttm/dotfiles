...
description: 技術ブログ、技術書、README、設計文書、Issue、PR、リリースノートなど、第三者が読む日本語の成果物を新規作成、推敲、リライトするときに使用する。Markdown や HTML に掲載する本文、見出し、説明文など、ファイルや外部サービスへ書き込む日本語文章も対象とする。通常のチャット回答、作業中の説明、コード、テスト、設定ファイル、commit message、ログ、内部的なメモの作成には使用しない。
---

# 日本語技術文書の文章規範

第三者が読む日本語の成果物を作成または推敲するときに、以下の規範を適用する。

対象には、技術ブログ、技術書、README、設計文書、Issue、PR、リリースノート、および Markdown や HTML に掲載する本文を含む。

通常のチャット回答、作業中の説明、コード、テスト、設定ファイル、commit message、ログ、内部的なメモには適用しない。
